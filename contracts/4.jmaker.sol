...
contract JewelryMaker {
    ...
    function updateDiamondToManufactured(uint outsidepwd, uint256 uniqueId, address newHolder
    ,string memory operationName, string memory remarks) external onlyOwner pwdcompare(outsidepwd){
        traceabilityNFT.updateDiamondStatus(uniqueId, IDiamondTraceabilityNFT.DiamondStatus.Manufactured, newHolder,operationName, remarks);
    }
