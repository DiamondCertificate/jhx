...
contract CuttingCompany {
    ...
    function updateDiamondToCut(uint outsidepwd,uint256 uniqueId, 
    address newHolder, string memory operationName, string memory remarks ) external onlyOwner()  pwdcompare(outsidepwd) {
        traceabilityNFT.updateDiamondStatus(uniqueId, IDiamondTraceabilityNFT.DiamondStatus.Cut, newHolder,operationName,remarks);
    }
